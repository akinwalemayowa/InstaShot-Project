...
export default function Home() {
  ...
  const [loadingMorePosts, setLoadingMorePost] = useState(false);
  ...
  useEffect(() => {
    if (!loading) setLoadingMorePost(false);
  }, [allPosts, loading]);
        ...
        <div className="grid grid-cols-12 gap-4 justify-between">
          ...
          <div className="col-span-12 lg:col-span-8">
            <div className="w-full max-w-[600px] 2xl:max-w-[700px] mx-auto">
              ...
              {error && (
                <span className="text-center text-red-500 my-4 text-sm">
                  {error}
                </span>
              )}
            </div>
          ...
          <div className="hidden lg:block col-span-12 lg:col-span-4">
            ...
            <h1 className="mt-10 text-sm text-gray-600">
              &copy; {new Date().getFullYear()} Instashots from Mayowa
            </h1>
          </div>
        </div>
      </Container>
